import '../cashout_two_screen/widgets/cashout_two_item_widget.dart';
...
class CashoutTwoScreen extends GetWidget<CashoutTwoController> {
  @override
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                          ...
                                                                          margin: getMargin(
                                                                              ...
                                                                              top: 17,
                                                                              right: 17),
                                                                          decoration: BoxDecoration(color: ColorConstant.bluegray701)),
                                                                      Container(
                                                                          height: getVerticalSize(
                                                                              18.00),
                                                                          width: getHorizontalSize(
                                                                      ...
                                                                      Align(
                                                                          alignment: Alignment
                                                                              .centerRight,
                                                                          child: Padding(
                                                                              padding: getPadding(left: 14, top: 23, right: 14, bottom: 13),
                                                                              child: Text("lbl_fees_apply".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLexendRegular12.copyWith())))
                                                                    ])),
                                                            Container(
                                                                height:
                                                                    getVerticalSize(
                                                                ...
                                                                child: Obx(() => ListView
                                                                    .builder(
                                                                        ...
                                                                        itemBuilder:
                                                                            (context,
                                                                                index) {
                                                                          CashoutTwoItemModel model = controller
                                                                              .cashoutTwoModelObj
                                                                              .value
                                                                              .cashoutTwoItemList[index];
                                                                          return CashoutTwoItemWidget(
                                                                              model,
                                                                ...
                                                                child: RichText(
                                                                    text: TextSpan(
                                                                        children: [
                                                                          TextSpan(
                                                                              text: "lbl_10_000".tr,
                                                                              style: TextStyle(color: ColorConstant.bluegray700, fontSize: getFontSize(18), fontFamily: 'Lexend', fontWeight: FontWeight.w700)),
                                                                          TextSpan(
                                                                              text: "lbl_00".tr,
                                                                              style: TextStyle(color: ColorConstant.bluegray700, fontSize: getFontSize(16), fontFamily: 'Lexend', fontWeight: FontWeight.w700)),
                                                                          TextSpan(
                                                                              text: ' ',
                                                                              style: TextStyle(color: ColorConstant.bluegray700, fontSize: getFontSize(22), fontFamily: 'Lexend', fontWeight: FontWeight.w400)),
                                                                          TextSpan(
                                                                              text: "lbl_ugx".tr,
                                                                              style: TextStyle(color: ColorConstant.bluegray700, fontSize: getFontSize(16), fontFamily: 'Lexend', fontWeight: FontWeight.w400))
                                                                        ]),
                                                                    textAlign:
                                                                        TextAlign
                                                                            .left))
  ...
  onTapColumnhome() {
    Get.toNamed(AppRoutes.cashoutOneScreen);
  }
