...
class CashoutItemWidget extends StatelessWidget {
  CashoutItemWidget(this.cashoutItemModelObj);

  CashoutItemModel cashoutItemModelObj;

  var controller = Get.find<CashoutController>();
