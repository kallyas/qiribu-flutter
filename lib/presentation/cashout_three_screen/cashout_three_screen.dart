import '../cashout_three_screen/widgets/cashout_three_item_widget.dart';
import 'controller/cashout_three_controller.dart';
import 'models/cashout_three_item_model.dart';
...
class CashoutThreeScreen extends GetWidget<CashoutThreeController> {
  @override
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomTextFormField(
                                  width: 313,
                                  focusNode: FocusNode(),
                                  controller: controller.group0773Controller3,
                                ...
                                CustomTextFormField(
                                  width: 114,
                                  focusNode: FocusNode(),
                                  controller: controller.priceThreeController3,
                                  hintText: "lbl_35_000_ugx".tr,
                                  margin: getMargin(
                                    left: 56,
                                    top: 6,
                                    right: 56,
                                        ...
                                        child: Obx(
                                          () => ListView.builder(
                                            ...
                                            itemCount: controller
                                                .cashoutThreeModelObj
                                                .value
                                                .cashoutThreeItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              CashoutThreeItemModel model =
                                                  controller
                                                          .cashoutThreeModelObj
                                                          .value
                                                          .cashoutThreeItemList[
                                                      index];
                                              return CashoutThreeItemWidget(
                                                model,
                                              );
                                            },
                                          ),
                                ...
                                CustomDropDown(
                                  ...
                                  items: controller.cashoutThreeModelObj.value
                                      .dropdownItemList,
                                  onChanged: (value) {
